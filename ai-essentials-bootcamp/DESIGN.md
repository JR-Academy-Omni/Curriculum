# AI 必修课 (AI Essentials Bootcamp) — Design Spec

> 4 周·零基础·各行各业 AI 入门实战
> 视觉系统所属：**入门 / 大众线**
...
```
设计任务：为「AI 必修课 (AI Essentials Bootcamp)」做配图 / 海报 / banner / 封面图。
课程定位：4 周·零基础·各行各业 AI 入门实战（入门 / 大众线）
...
入门课的基石色——明亮、友好、零门槛。沿用 JR 品牌四色中的标志性黄。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #FFDE59;`
