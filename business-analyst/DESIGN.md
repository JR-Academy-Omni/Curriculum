# AI 产品经理 (BA) 训练营 + 实习 — Design Spec

> Business Analyst·本地工作经验·实习直通
> 视觉系统所属：**职业 / 职场线**
...
```
设计任务：为「AI 产品经理 (BA) 训练营 + 实习」做配图 / 海报 / banner / 封面图。
课程定位：Business Analyst·本地工作经验·实习直通（职业 / 职场线）
...
BA 是「分析/冷静」的角色——薄荷绿（绿+蓝过渡）比 IT Career 的纯绿更「理性」。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #4ECDC4;`
