...
- [ ] 创业营奖学金机制（§10）— **v0 草案已立**，待 Lightman + 商务 + 会计拍板名额 / 金额 / 资金来源 / 资格方案 / 税务措辞
...
- 2026-06-18 新增 §10 创业营奖学金（"一人奖学金"）v0 草案：每期 1 名、全额学费 rebate、**学完达标 6 项硬指标才发**（先付费后返还，反白嫖 + 激励对齐 + 喂飞轮 hero case）。默认资格用纯 merit（方案 C，看毕业产出不看申请书），资金来源建议优先谈合作方 / 投资人冠名赞助。名额 / 金额 / 税务措辞待 Lightman + 商务 + 会计确认
...
## 10. 创业营奖学金（"一人奖学金" · 学完才发）

> 形态：每期 cohort 评选 **1 名**「一人奖学金」得主，**全额学费返还（rebate）**，**毕业达标后才发** —— 不是免费送座位，是"先付费、做出来、再返还"。名字呼应「AI 一人创业营 → 一人奖学金」。

### 10.1 为什么这样设计（机制目的）

- **筛选 + 反白嫖**：先正常付费（或付定金）入营，达标毕业才返还 → 没拿到奖学金的人也是正常付费学员，业务零损失；想白嫖的人因为"要先付 + 要真做出来"自动退场。
- **激励对齐**：只奖励"真的把一人公司做出来"的人（达标 = 6 项硬指标），不奖励"会写申请书 / 会讲故事"的人。
- **飞轮燃料**（接 [VISION.md](./VISION.md) §2）：得主 = 下一期招生最硬的 hero case。花 1 个名额的学费，换最强社会证明 + 一个真实毕业故事；**只在"已经证明模型成立"的人身上花钱**。

### 10.2 资格 —— 谁能争取（入口条件）

- 必须先通过常规**申请制**录取（LinkedIn 必填 + 24-48h 审核）。奖学金**不是**录取绿色通道。
- 怎么定"什么条件"，三个方案待 Lightman 选（建议默认 C）：
  - **方案 A · 潜力 + 故事型**：报名时提交「我为什么做这家一人公司 + 已经做了什么」，择优 —— 偏 case study 传播价值。
  - **方案 B · 需求型**：证明有真实创业意图、且学费是真实门槛（need-based）—— 偏品牌善意 / 普惠叙事。
  - **方案 C · 纯 merit（推荐默认）**：不额外申请，直接以**毕业表现**（见 10.3）评选 —— 最公平、最省运营、最贴合本课"看真产出不看 PPT"的调性。把"条件"放在产出端，不放在申请端。

### 10.3 发放条件 —— "学完才行" 的硬闸（缺一不可）

得主必须**完整毕业 + 达成全部 6 项硬指标**（与 §3 / outline.json 完全一致，不另立标准）：

1. 收到第一笔真实付费（$1+，不接受友情付）
2. 完成 ABN 注册
3. 提交至少 1 个澳洲 Grant 申请（提交 ≠ 拿到）
4. 产品 URL Live
5. 产出 10+ 营销内容
6. Demo Day 现场出席

- **没达标 = 没奖学金**，按正常学费结算（已付不退）。这就是"学完才行"的落地。
- 出勤门槛：[商务确认，建议直播出勤 ≥ 90%]。
...
| 项 | 建议 | 备注 |
|---|---|---|
| 名额 | 每期 **1 名** | "一人奖学金"，稀缺=含金量；50 人 cohort 返 1 份，财务可控 |
| 金额 | **全额返还得主所付学费** | headline："学完并做出一人公司 → 学费全免" |
| 资金来源 | (a) JR 自担 / **(b) 冠名赞助（优先）** | (b) 接 [PARTNERSHIP_PROGRAM_PLAN.md](./PARTNERSHIP_PROGRAM_PLAN.md)：如「混沌澳洲奖学金」/「极客公园奖学金」/「某投资人奖学金」，赞助方出钱、得冠名曝光 + 与得主故事绑定 —— 省成本又深化合作，**建议优先谈冠名** |

### 10.6 红线

- **不承诺金钱 / 收入** —— 奖学金 = 学费返还，**不是创业奖金、不是收入**；对外严禁"做创业赢奖金 / 学完就能赚 X"措辞。
- **税务** —— 学费返还 / 奖学金在澳洲可能有税务处理，对外措辞前 **[会计 / 商务确认]**，不凭空说"免税"。
- **条件透明可追溯** —— 6 项硬指标 + 评选 3 标准必须**事前白纸黑字公示**，不临时改规则；写进报名条款。
- **不夸大概率** —— "每期 1 个名额"如实说，不暗示"人人有机会拿"。
- **达标即按约发** —— 得主达标并按公示标准选出后，必须如约返还，不得以成本为由反悔。

> ⚠️ 状态：v0 机制草案（2026-06-18）。名额 / 金额 / 资金来源 / 资格方案 A·B·C / 出勤门槛 / 税务措辞均待 Lightman + 商务 + 会计确认后，再同步进 landing.html、报名条款、`course-custom-landing` 销售页与报名表单。

---

## 11. 会员专属层 — OPC Founder 持续服务包（与公开雷达分层）

> 🚨 **两层分清（这是核心思路，别混）**：
> - **① 公开机会雷达** = `/blog/ai-hackathon-weekly`，**免费、全员可看、引流/SEO**（数据由 2 个 schedule cloud routine「OPC 机会雷达 (公开引流)」每周产出 → PROMOTION_PLAN §3 渠道 #11）。**不叫"专属"**。
> - **② 会员专属服务** = 本节，**报名后才有，是产品价值/留存，不是营销内容**。"专属"二字只用在这一层。
> 公开层负责把人勾进来，专属层负责"为什么值这个学费 + 为什么留下来"。

> 立意：一人公司 founder 真正过不去的就 **3 件事 —— 找钱 / 搞钱 / 不踩坑**（知识网上都有，不缺）。专属层按这 3 件事填，且**按三档分级**（自学给清单/模板，标准给日历/审核，陪跑给 1v1），全部对齐毕业 6 项硬指标，不承诺金钱（CLAUDE.md 红线）。

### 11.0 搞钱机会全类型地图（公开雷达 vs 专属层的总账）

> 一个 AI 一人公司能碰到的钱拆成 **10 类**。切分：**公开雷达放「有哪些 + 官方链接」（找钱类为主，引流/SEO）；专属层放「怎么真的拿到 + 帮你做」（搞钱类打法 + 找钱类的申得上操作层 + 不踩坑）**。钩子 = 免费版让人看到「原来有 10 类，我只会 2 类」→ 想要后 8 类打法 → 进营。

| # | 类型 | 3 件事 | 公开雷达给（免费） | 专属层加（报名后） |
|---|---|---|---|---|
| 1 | **黑客松 Hackathon** | 找钱 | 名单 + 奖金 + 截止 + 官方报名链接 | 选题/组队/48h demo 打法 + 往届拆解 |
| 2 | **奖金赛 Competition** | 找钱 | 名单 + 榜单 + 官方链接 | 刷榜策略 + 算力 credits 对接 |
| 3 | **免费 credits / 算力** | 找钱(省钱) | 清单 + 官方申请链接 | 资格自检 + 申请话术 + 1v1 陪申 |
| 4 | **加速器 Accelerator** | 找钱 | 是什么 + 换不换股权认知 | 申请材料 + 该不该进的判断 |
| 5 | **政府 Grant** | 找钱 | 能不能申认知 + 官方链接 | RDTI/EMDG 清单 + 日历 + proposal 1v1 过稿 |
| 6 | **接单 / 外包 freelance** | 搞钱 | 仅提"有这条路" | 渠道 + 定价 + 第一单怎么拿 |
| 7 | **开源 Bounty / 回溯资助** | 搞钱 | 仅提 | 平台 + 怎么挑高 ROI bounty |
| 8 | **平台分成 / 创作者基金** | 搞钱 | 仅提 | GPT Store / Poe 上架 + 被动收 |
| 9 | **Affiliate / 推广佣金** | 搞钱 | 仅提 | 高佣工具清单 + 内容矩阵 |
| 10 | **自有产品付费 MRR** | 搞钱(终局) | 仅提 | 比赛/服务 → 产品化收费转化打法 |
| ＋ | **澳洲合规(ABN/GST/结构)** | 不踩坑 | 通用决策指南 | 持牌律师过的合同/隐私模板 + 1v1 |

> **落地分工**：第 6-10 类「搞钱」打法在**课程正文**（W-modules / outline.json）教；第 1-5 类「找钱」的"申得上"操作陪跑 + 内部需求池 + 不踩坑合规，是下面的**持续服务包三档**。公开雷达 = 第 1-5 类的"有哪些 + 链接"（`/blog/ai-hackathon-weekly`，数据吃 `omni-report/hackathon-radar/` 执行结果）。

| 专属服务 | founder 哪件事 | 自学陪练版 $2,800 | 标准版 $3,800 | 陪跑版 $6,800 | 对齐 |
|---|---|---|---|---|---|
| **澳洲补贴 / Grant 申请陪跑** | 找钱 | 雷达精选 + 申请清单/模板（RDTI / EMDG / 州 grant）| + 个人申请日历 + 截止提醒 + 嘉宾作业级 review | + 申请书 1v1 过稿（持牌 CPA / Grant consultant）| 毕业硬指标 #3「提交 Grant」+ RDTI 卖点 + Persona C |
| **Startup credits 申请陪跑** | 找钱（省钱）| credits 清单 + 资格说明 + 话术模板（AWS / Anthropic / OpenAI / Google / MS）| + 帮判断资格 + 申请话术 review | + 1v1 陪申 | 一人公司省 $5-50k 算力/工具钱；Persona A/B 即时爽点 |
| **同学内部需求池 / 互相接单** | 搞钱（第一笔付费）| 进群可发可接需求 | + VIP 晚宴现场撮合 + 需求看板 | + 主理人定向撮合 | 毕业硬指标 #1「$1+ 真实付费」常来自身边同侪 |
| **澳洲合规包（模板 + 架构）** | 不踩坑 | ABN / GST / structure 决策指南 + 通用模板 | + 持牌律师过的合同 / 隐私模板 | + 1v1 结构 / 合规答疑 | Persona C 命脉；毕业硬指标 #2「ABN 注册」|

### 红线（强制）

- ❌ **不承诺拿到 grant / credits / 收入** —— 只承诺「教你怎么申请 + 陪你提交」，提交 ≠ 通过（与 §3 / §10 红线一致）。
- ⚠️ **合规模板 = 持牌专业人士过的通用版，不替代个案法律 / 税务意见**，对外措辞需 [法务 / 会计确认]。
- ⚠️ **内部需求池是撮合，JR 不担保交易、默认不抽成**（如要抽成 / 担保另定）。
- ⚠️ credits / 补贴的资格与额度以官方为准，雷达只给线索。

### 落地依赖（开课前补）

- 补贴 / credits **模板库 + 申请日历**（待建；数据可吃公开雷达 `hackathon-radar/`）
- 内部需求池（admin 看板 / 群运营，可接 `cohort-ops-conductor`）
- 合规模板（待法务 / CPA 出通用版）
- 本节先定**承诺边界 + 三档分级**；具体交付物 + landing 文案落地前 Lightman / 商务 / 法务确认。
- **承接界面（学员登录态操作台）= 「OPC 会员工作台」**，把本节 4 服务包落成按档位解锁的产品 → 见 [`docs/prd/OPC_MEMBER_WORKBENCH_PRD.md`](../../docs/prd/OPC_MEMBER_WORKBENCH_PRD.md)（status=spec，本节是其内容 SoT）。
