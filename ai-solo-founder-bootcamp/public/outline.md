...
- **[Live] 选你的 AI 秘书 — 5 方案深度对比 + 选型决策** — 120 分钟 · 🔴直播
- **[Lab] 装机 + 基础配置 + 第一次对话验收（按你 L11b 选的方案分组）** — 90 分钟
- **[Live] 接通公司核心数据：Gmail / Calendar / Drive / Notion / Slack 全部喂进 agent** — 120 分钟 · 🔴直播
- **[Live] 7 个秘书任务现场 ship — 让你有『企业秘书 / 大脑』的真实感觉** — 120 分钟 · 🔴直播
- **[Self] 进阶 — 切换 / 双 agent 配合 / 自建 / 团队 Brain** — 60 分钟
- **[Live] Agent Schedule 工作坊：5 个真实案例一起做（Claude Code / Codex / Cowork / OpenClaw 跨平台）** — 120 分钟 · 🔴直播
...
- **[Live · 嘉宾] Fireside chat 2：Antler 墨尔本 / Startmate 悉尼** — 90 分钟 · 🔴直播
- **[Self] OPC vs VC 路线决策表** — 60 分钟
- **[Live] Demo Day Day 1 — 三城联合直播 + 每人 5min Demo** — 240 分钟 · 🔴直播
