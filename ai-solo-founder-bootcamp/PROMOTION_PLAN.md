...
| **目标 Target Enrollment** | **20 人 ±5**（墨 10-12 / 悉 6-8 / 布 3-5，PRD 保守版）⚠️ 销售页另写 40-60，两数不一致待 Beta 拍板 |
| 录取机制 | 申请制 + LinkedIn 必填（首期无视频面试，目标录取率 30-50%）|
| Status | spec（PRD 刚写好，未开工；本方案是开工前规划）|
...
落地页 / lead-magnet UV 目标：~800 人
  ↓ 各渠道流量分摊（Type 3 创业孵化基线 — 不是小红书主导！）
  - 1v1 私聊 + 创业者圈层 + LinkedIn DM：占转化大头（量小质高，主战场）
  - LinkedIn 长文（英文创业者圈 + Faculty 背书）：~240 UV（30%）
  - 公众号 / 知乎深度长文（一人公司 / RDTI 实战）：~200 UV（25%）
  - 老学员 / 校友群定向私聊（AI Engineer / OpenClaw 校友，PRD 写 70% 生源）：高转化（不计 UV，直接进申请）
  - 线下 founder 沙龙（墨 / 悉，闭门邀请）：~120 UV（15%）
  - 小红书少量种草（B/C 切角）：~160 UV（20%，曝光为主非转化）
...
| **Lightman** | 预算审批 / 二期升价决策 / 红线把关 / 三城招生数 vs 销售页数（20 vs 40-60）拍板 | 付费投放 / 升价必须他拍板 |
...
- ⚠️ **招生目标 20 vs 销售页 40-60 不一致** — 待 Lightman / Beta 拍板
