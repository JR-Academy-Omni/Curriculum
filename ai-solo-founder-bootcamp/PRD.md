...
- 💰 首期定价改三段式："预售 → 首期早鸟 → 第二期"
  ...
  - EARLY BIRD: AUD **$2,800** · 预售关闭后剩余席位（首期共 18-25 人）
...
- 📊 首期总收入预期下调：~22 人 × ~$2,500 均价 ≈ $50-60k（旧版 $72-100k 预期）——首期定位为 case study 引流，不是利润中心
- ⚠️ **2 个动作要 lightman 拍板** — landing.html 已留 TODO 占位符：
  - 定金金额未定（$200 / $500 / $880 都待定）+ 定金转全款的规则（预售期截止前如何收尾）
...
```
首期澳洲（验证 + 建 SOP）       — 18-25 人 × ~$2.5k 均价 = ~$50-60k 收入（v0.4 调整 · 持平就好）
       ↓ 6-8 周
...
| **JR 这门课** | **AI 一人创业营** | **AUD $2.4k 预售 / $2.8k 首期早鸟 / $3.8k 二期** | **18-25 人首期** | **澳洲华人专属 + AI 工具栈 + Grant + 三城线下** |
...
**首期不是收入产品，是 LTV 引擎**：18-25 人 × ~$2.5k 均价 ≈ $50-60k 收入（v0.4 阶梯），勉强覆盖嘉宾费 + 三城场地 + 运营。真正产出是 5-8 个真实赚钱的毕业 case study + SOP——LTV 在第二期之后才能跑回来。
...
| 档位 | 价格 | 触发条件 | 包含 |
|------|------|---------|------|
| 🔥 **PRE-SALE** · 限 15 席 | **AUD $2,400** | 先到先得 · 可付定金 [待定] 锁席 · 满 15 即关闭 | 11 周课程 + 三城线下 + 10 类 Faculty + Demo Day + 校友群 + 6 个月 Office Hour |
...
| 6 | 申请录取目标 | 18-25 人 / 录取率 30-50% | lightman |
