...
>
> ⚠️ **落地待办**：第二位 8 折需同步进 `landing.html` 价格区 / 报名表单（加「第二位员工」选项 + 自动算价）/ 报名条款 / `course-custom-landing` 销售页，并与 prod program 的优惠逻辑（见 CHANGELOG 2026-06-30 早鸟价修复）对齐——目前仅 PRD 立条款，对外未上。
