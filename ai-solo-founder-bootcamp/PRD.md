...
```
首期澳洲（验证 + 建 SOP）       — 18-25 人 × $4k = ~$80-100k 收入（持平就好）
       ↓ 6-8 周
...
| **JR 这门课** | **AI 一人创业营** | **AUD $4.8-6.8k** | **18-50/期** | **澳洲华人专属 + AI 工具栈 + Grant + 三城线下** |
...
1. **首期定价低开高走** — 首期 $3,800-$4,800（含早鸟），明说"首期为建立 case study，仅此一期"。第二期起 $5,800+。
...
**首期不是收入产品，是 LTV 引擎**：18-25 人 × $4k = $72-100k 收入，覆盖嘉宾费 + 三城场地 + 运营即可。真正产出是 5-8 个真实赚钱的毕业 case study + SOP。

---

## 8. 定价策略

### 8.1 首期定价（case study price）

| 档位 | 价格 | 包含 |
|------|------|------|
| Early Bird（前 30 天） | **AUD $3,800** | 12 周课程 + 三城线下 + 嘉宾 + Demo Day |
| Standard | **AUD $4,800** | 同上 |
| Premium（含 1:1 mentorship） | **AUD $6,800** | 同上 + 12 次 1:1 教练（每周 30 min） |

明说"首期为建立 case study，价格只此一期"。

### 8.2 第二期起标准定价

| 档位 | 价格 |
|------|------|
| Early Bird | AUD $4,800 |
| Standard | AUD $5,800 |
| Premium | AUD $9,800 |
...
| 4 | 首期定价档位 | $3.8k / $4.8k / $6.8k 三档 | lightman |
