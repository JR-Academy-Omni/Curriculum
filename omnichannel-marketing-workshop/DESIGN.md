# 全渠道营销 Workshop — Design Spec

> Omnichannel Marketing·多平台投放整合
> 视觉系统所属：**营销 / 创作线**
...
```
设计任务：为「全渠道营销 Workshop」做配图 / 海报 / banner / 封面图。
课程定位：Omnichannel Marketing·多平台投放整合（营销 / 创作线）
...
营销线的「轻量小课」配色——比 AI Marketing 4 周班的玫红浅一档，比小红书粉更柔。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #FF6B9D;`
