...
(function () {
  const XHS_COPY = {
    ...
    p4: { title: '3 小时学完 你会真的会 4 件事', body: `3 小时 GP Workshop 具体落地 📌\n\n1️⃣ 看懂 6 行业招聘日历 — Big 4 / Banks / Gov / Consulting / Tech / Engineering\n2️⃣ STAR + ATS 改简历 — 当场看老师改 1-2 条 bullet\n3️⃣ OA + Video 不紧张 — SHL / Pymetrics / HireVue 各家题型\n4️⃣ 5-7 STAR 故事模块 — 实习 / 社团 / 兼职拆成可拼装的库\n\n每项都有配套模板带走。`, tags: '#GraduateProgram #简历 #STAR #校招', wechat: ['学完 4 件事：日历 / 简历 / OA / STAR 💪','3h 不学概念 — 学能直接用的方法。','带走 8 份模板 — 课后立刻能动手改。'], community: ['【4 件能力】\n✅ 6 行业招聘日历\n✅ ATS 简历改写\n✅ OA 通关思路\n✅ STAR 故事工程\n每件都有模板 📌'] },
    p5: { title: '3 小时 7 个 Block 完整结构', body: `市面"留学生求职课"大多泛泛而谈 — 这门课每个 Block 都有具体产出 🗺️\n\nL00 开场 + 3 误区（5 min）\nL01 GP 认知 + 招聘日历（20 min）\nL02 找 GP + 投递追踪表（20 min）\nL03 Resume + Cover Letter 现场改（35 min）\nL04 OA + Video 通关（20 min）\nL05 STAR 面试 + Breakout 演练（45 min ⭐）\nL06 Networking + AC 战术（25 min）\nL07 Q&A + 资源包（10 min）`, tags: '#GraduateProgram #校招 #求职课程', wechat: ['7 个 Block 把招聘漏斗每一关拆开 🗺️','L05 STAR 那 45 分钟是核心 · Breakout 现场演练','3h Workshop 信息量大 · 带录播。'], community: ['【7 Block 全景】\nL00 开场 + 3 误区\nL01 招聘日历\nL02 投递清单\nL03 简历改写\nL04 OA 通关\nL05 STAR 面试 ⭐\nL06 AC 战术\nL07 Q&A 🗺️'] },
    p6: { title: '澳洲申 GP 必备 12 个工具', body: `不是工具课 — 是工具 + 方法论 🛠️\n\n📅 找岗位：GradAustralia / Prosple / GradConnection / SEEK Grad\n💼 校友：LinkedIn\n🧠 Aptitude：SHL / Cut-e / Practice Aptitude Tests\n🎮 Pymetrics（Big 4 / Banks 高频）\n🎥 HireVue 录播视频面\n📝 ATS 检测：Jobscan\n📊 追踪：Notion 投递表\n\n每个工具都有具体怎么用。`, tags: '#GraduateProgram #LinkedIn #Pymetrics #求职工具', wechat: ['GP 求职 12 个工具栈 — 每个都有具体用法 🛠️','SHL / Pymetrics / HireVue — 各家招聘必经','工具不是越多越好 — 是用对场景。'], community: ['【12 个工具栈】\n岗位：GradAustralia / Prosple\n校友：LinkedIn\nAptitude：SHL / Cut-e\nSJT：Pymetrics\nVideo：HireVue\nATS 检：Jobscan 🛠️'] },
    p7: { title: '3 小时听完 知道往哪走', body: `学员群里几条真实反馈 💬\n\n"课前自己投 30 多家 0 OA。照 L03 改了简历，下一轮 10 家来了 4 个 OA"\n"STAR 45 分钟最值。把社团 + 实习 + 兼职拆成 6 个故事 — 面试不慌"\n"原来 6 行业招聘日历差这么多 — 我大三上错过 Big 4 一轮"\n\n3 小时不解决一切 — 至少给你地图。`, tags: '#GraduateProgram #学员反馈 #校招经验', wechat: ['学员反馈：照方法改简历 下一轮 4 个 OA 💬','STAR 45 分钟 = workshop 灵魂 · Breakout 现场演练','3h 不解决一切 — 至少给你地图。'], community: ['【真实反馈】\n"重投 10 家 4 个 OA"\n"6 故事 模块化"\n"招聘日历救了一轮"\n留学生日常 💬'] },
    p8: { title: '不只是 3h 直播 是完整方法包', body: `看了一圈同类课 — 要么贵到上千要么内容散 📘\n\n这次买到手的：\n📘 3 小时 Zoom 直播\n📦 7 个 Block · L00-L07\n🧰 8 份能直接用的模板\n👥 1 次 Breakout Room 演练\n\n+ 课后 24h 录播\n+ 课前 1 周可上传简历（脱敏后老师当场改）\n+ Notion / Excel 投递表 + STAR Worksheet\n+ LinkedIn 邀约话术中英双版`, tags: '#GraduateProgram #Bootcamp #校招课', wechat: ['3h 直播 + 8 份模板 + 录播 + 1v1 简历审改 💼','不是录播合集 — 是直播 + 模板 + 录播 + 互动一整套。','课前 1 周可上传简历 = 免费 1v1 简历精修机会。'], community: ['【你买到的】\n📘 3h Zoom 直播\n🧰 8 份模板\n👥 1 次 Breakout\n📺 24h 录播\n📂 课前简历审改'] },
    ...
    p10: { title: '不是泛泛的留学生职业规划课', body: `这不是一门"上岸速成班" — 是把招聘漏斗每一关拆开教方法 🗺️\n\n一句话：\n👉 GP Workshop = 不是教你"投简历"，是教你 5 关漏斗每一关该做什么。\n\n3 小时节奏：\n• 第 1h：认知 + 找岗位 + 简历\n• 第 2h：OA + STAR 故事工程\n• Breakout：3-4 人 STAR 演练 10 min\n• 第 3h：AC 战术 + 资源包\n\n3 小时给你地图 + 模板，路自己走。`, tags: '#GraduateProgram #求职规划 #校招', wechat: ['GP Workshop = 招聘漏斗每一关方法 不是"上岸课" 🗺️','3h 节奏：认知 + 简历 + OA + STAR + AC','不教你套路 — 教你 5 关漏斗每一关的方法。'], community: ['【课程定位】\nGP Workshop\n= 招聘漏斗每一关方法\n不是"上岸课"\n3h · 7 Block · 录播 🗺️'] },
    p11: { title: '课前 vs 课后 多会什么', body: `报课前最关心的不是大纲 — 是"学完到底多会什么" 💪\n\n6 维度对比：\n🔸 找岗位：SEEK 海搜 → 6 行业日历\n🔸 简历：通用模板 → JD 反推 ATS\n🔸 Cover Letter：复制 GPT → 4 段式调研\n🔸 OA：考前 1 天查 → 题型 + 时间练熟\n🔸 面试：背模板 → 5-7 故事拼装\n🔸 Networking：发"求内推" → 校友邀约话术`, tags: '#GraduateProgram #能力升级 #求职课', wechat: ['6 维度看课程效果：日历 / 简历 / OA / STAR / Networking 💪','报课前看这张 — 学完具体多会什么。','每一维都从"卡住"到"有方法"。'], community: ['【6 维升级】\n找岗位：海搜 → 日历\n简历：模板 → JD 反推\nOA：临时抱佛脚 → 题型\n面试：背 → 拼装 💪'] },
    ...
    p15: { title: '8 份模板带走 不止是听', body: `Workshop 最值钱的是带走的模板 — 不是听 是真用 🧰\n\n📅 6 行业招聘日历对照表（PDF）\n📊 投递追踪表 ×2（Notion + Excel）\n📝 ATS Graduate Resume 模板\n📝 Cover Letter 4 段式骨架\n💬 STAR 故事工程 Worksheet\n🤝 LinkedIn 邀约话术 ×2（中英）\n\n每份都能直接复制改名用。`, tags: '#GraduateProgram #简历模板 #求职模板', wechat: ['8 份模板带走 — 不是听课是真用 🧰','日历 + 投递表 + 简历 + STAR + LinkedIn','买课最怕只剩 PPT — 这次都是能用的模板。'], community: ['【8 份模板】\n6 行业日历\n投递表（Notion+Excel）\nResume + Cover Letter\nSTAR Worksheet\nLinkedIn 话术（中英）🧰'] },
    ...
    p17: { title: '3 小时结束 带走 8 件真东西', body: `不是听完就完 — 带走 8 件能用的 📂\n\n01 6 行业招聘日历对照表\n02 投递追踪表（Notion + Excel）\n03 ATS Graduate Resume 模板\n04 Cover Letter 4 段式骨架\n05 STAR 故事工程 Worksheet\n06 Video 30 秒自介 3 模板（Consulting/Tech/Finance）\n07 LinkedIn + Coffee Chat 话术（中英）\n08 3 小时录播 + Q&A 回看\n\n每件都能直接用。`, tags: '#GraduateProgram #毕业交付 #求职模板', wechat: ['3h 结束带走 8 件真东西 — 不是听完就完 📂','日历 / 投递表 / 简历 / STAR / LinkedIn / 录播','30 秒自介 3 模板 = Consulting / Tech / Finance 各 1。'], community: ['【8 件交付】\n01 日历表\n02 投递表\n03 Resume\n04 Cover Letter\n05 STAR Worksheet\n06 Video 模板\n07 LinkedIn 话术\n08 录播 📂'] },
    ...
    p22: { title: '行为面 90% 用 STAR', body: `STAR 框架很多人听过 — 但用得好的不多 🎯\n\nS Situation（20%）：1 句话讲背景 — 不要 45 秒铺垫\nT Task（10%）：你的角色 + 明确 deliverable\nA Action（50%）：用"我"不用"我们" — 具体做了什么\nR Result（20%）：量化数字 — % / $ / 人 / 时间\n\n课上 L05 整整 45 分钟讲 STAR + 12 类高频题 + Breakout 现场演练。`, tags: '#STAR #BehaviouralInterview #面试技巧 #校招', wechat: ['STAR 框架：S 情景 T 任务 A 行动 R 结果 🎯','行为面 90% 用 STAR — 但用得好的人很少。','L05 那 45 分钟最值 · Breakout 现场演练 + 老师点评。'], community: ['【STAR 框架】\nS 1 句背景（20%）\nT 你的角色（10%）\nA "我"做了什么（50%）\nR 量化结果（20%）\n12 类高频 + Breakout 🎯'] },
    p23: { title: '别的求职课没有这 2 块硬货', body: `市面留学生求职课大多套路 — 这 2 块是别人没做的硬货 🔥\n\n🗺 L01 · 6 大行业招聘日历\n— 大多课只讲 Big 4 · 这里 Big 4 / Banks / Gov / Consulting / Tech / Engineering 全讲透 · 每年开课前核对当期最新数据\n\n💬 L05 · STAR 故事工程方法\n— 不是教你背 12 个标准答案 · 是把 5-7 真实经历模块化打 tag · 现场拼装应对不同问题\n\n这 2 块决定你能不能进 AC。`, tags: '#GraduateProgram #STAR #校招方法', wechat: ['2 块独家硬货：6 行业日历 + STAR 故事工程 🔥','别的留学生求职课大多只讲 Big 4 — 我们 6 行业全讲。','STAR 不是背 — 是模块化拼装。'], community: ['【2 块独家】\n🗺 6 行业招聘日历\n💬 STAR 故事工程\n每年开课前核对\nL05 整整 45 分钟 🔥'] },
