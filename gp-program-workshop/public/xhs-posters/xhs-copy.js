...
(function () {
  const XHS_COPY = {
    ...
    p12: { title: 'L01 6 大行业差异都讲一遍', body: `市面 GP 课大多只讲 Big 4 — L01 把 6 大行业都过一遍 🎯\n\n🏢 Big 4 Audit/Consulting · 上半年开放为主 · 485 部分接受\n🏦 四大银行 + Macquarie · 多要 PR / Citizen\n🏛 Gov Grad（NSW / VIC / APS）· 战线长 · 多要 PR\n💻 Tech（Atlassian / Canva / REA）· 滚动招聘 · 485 友好\n🎯 Tier-1 Consulting（BCG / Bain）· Big 4 同期前后\n🛠 Engineering · 年中开较多 · 矿业偏 PR\n\n具体哪个月开打开公司 careers 看 — 那是最权威的。`, tags: '#Big4 #澳洲GP #6行业', wechat: ['L01 不只讲 Big 4 — 6 大行业都过一遍 🎯','Tech / Engineering / Gov / Banks 各自侧重 + 签证偏好','具体月份让你回去自己查官网 — 最权威。'], community: ['【L01 · 6 大行业】\nBig 4 · Banks · Gov\nConsulting · Tech · Eng\n各自侧重 + 签证 + 面向人群\n月份去 careers 查 🎯'] },
