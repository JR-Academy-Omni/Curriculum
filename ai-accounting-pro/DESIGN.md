# AI 会计 Pro（6 周深度） — Design Spec

> Corporate / 事务所·month-end close·13-week 现金流
> 视觉系统所属：**垂直行业线（会计/财务）**
...
```
设计任务：为「AI 会计 Pro（6 周深度）」做配图 / 海报 / banner / 封面图。
课程定位：Corporate / 事务所·month-end close·13-week 现金流（垂直行业线（会计/财务））
...
会计/财务的传统符号色——「账本绿/美元绿」。比 IT Career 的 JR 绿更深更稳，对应「6 周深度」。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #3D8B6B;`
