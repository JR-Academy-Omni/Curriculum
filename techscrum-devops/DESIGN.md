# TechScrum DevOps 项目实训营 — Design Spec

> 7 周·真实 TechScrum Web 项目·初级 DevOps 进阶
> 视觉系统所属：**工程 / 技术线**
...
```
设计任务：为「TechScrum DevOps 项目实训营」做配图 / 海报 / banner / 封面图。
课程定位：7 周·真实 TechScrum Web 项目·初级 DevOps 进阶（工程 / 技术线）
...
DevOps 主题色——「管道/流水线/绿色部署」的语义直接对应 Teal。也避开了 IT Career 的标准 JR 绿。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #10B981;`
