# Claude Cowork SME Workshop（4 小时·中小企业主） — Design Spec

> 一人公司 / 1-3 人小团队·餐饮零售设计咨询
...
```
设计任务：为「Claude Cowork SME Workshop（4 小时·中小企业主）」做配图 / 海报 / banner / 封面图。
课程定位：一人公司 / 1-3 人小团队·餐饮零售设计咨询（合作品牌线（Anthropic））

═══ 主题色（必须严格执行）═══
主色：#C96442（Anthropic 棕橙）
主色上的文字色：#FFFFFF
...
Cowork 系列深一档——SME 版给老板/创始人，比通用 3h 版更「商务」。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #C96442;`
