...
export default function L04b_MarketData() {
	return (
			...
			<div style={{
				...
				<motion.div initial={{ opacity: 0, y: -14 }} animate={{ opacity: 1, y: 0 }}>
					<div style={{
						...
						<span style={{ fontFamily: fonts.mono, fontSize: 15, fontWeight: 800, color: colors.black }}>MARKET · 2026</span>
					</div>
					<h2 style={{
					...
					<div style={{
						...
						{salaries.map((s, i) => (
							...
							>
								...
								<div style={{
									fontFamily: fonts.mono, fontSize: '20px',
