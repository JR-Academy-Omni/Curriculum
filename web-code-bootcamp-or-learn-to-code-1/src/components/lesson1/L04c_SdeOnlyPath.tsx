...
export default function L04c_SdeOnlyPath() {
	return (
							...
							{traditionalStack.map((it, i) => (
								<li key={i} style={{
									...
									<div>
										...
										<div style={{ color: 'rgba(255,255,255,0.55)', fontSize: 14, marginTop: 2 }}>{it.note}</div>
									</div>
								</li>
							))}
						</ul>
							...
							{aiEngineerStack.map((it, i) => (
								<li key={i} style={{
									...
									<div>
										...
										<div style={{ opacity: 0.72, fontSize: 14, marginTop: 2 }}>{it.note}</div>
									</div>
								</li>
							))}
						</ul>
