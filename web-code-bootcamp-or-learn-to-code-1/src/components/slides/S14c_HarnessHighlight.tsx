...
/**
 * S14c — Harness Engineering 深度专讲
 * 移植自 ai-engineer-bootcamp/S21_HarnessHighlight，p8 → m8
 * 全栈班学员看到的"进阶视野"，对应 AI Engineer 班的核心
 */
export default function S14c_HarnessHighlight() {
	return (
		<Slide bg={colors.m8} style={{ position: 'relative', overflow: 'hidden' }}>
			<div style={{
			...
			<div style={{ position: 'relative', zIndex: 1, width: '94%', maxWidth: 1400, padding: '36px 40px' }}>
				<motion.div
					...
					style={{
						...
						fontFamily: fonts.mono, fontSize: 16, fontWeight: 900, letterSpacing: 0.5,
				...
				>
					Harness<br />
					<span style={{ display: 'inline-block', background: colors.white, color: colors.m8, padding: '0 14px', border: `4px solid ${colors.black}`, boxShadow: `6px 6px 0 ${colors.black}`, transform: 'rotate(-1deg)', marginTop: 6 }}>
						Engineering
					</span>
				</motion.h2>
				...
				<div style={{ display: 'grid', gridTemplateColumns: '1fr 1.15fr', gap: 32, marginTop: 28, alignItems: 'stretch' }}>
					...
					>
						<div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
							...
							<span style={{ fontFamily: fonts.mono, fontSize: 14, color: 'rgba(255,255,255,0.5)', fontWeight: 700 }}>
							...
							{[
								...
								>
									<div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
										...
										<div style={{ fontFamily: fonts.heading, fontSize: 16, fontWeight: 900, color: colors.black, letterSpacing: -0.3 }}>
											{m.name}
										</div>
									</div>
									<div style={{ fontFamily: fonts.mono, fontSize: 13, color: '#444', fontWeight: 700 }}>
										{m.sub}
									</div>
								</motion.div>
							))}
						...
						<div style={{ marginTop: 10, fontFamily: fonts.mono, fontSize: 13, color: 'rgba(255,255,255,0.5)', fontWeight: 700, textAlign: 'center' }}>
					...
					<div style={{ display: 'flex', flexDirection: 'column', gap: 14, justifyContent: 'center' }}>
						{[
							{ n: '01', title: '你不只会写 Agent', hl: '你能造出 Agent 的 IDE', delay: 0.8 },
							{ n: '02', title: 'Hook System + Skills 范式', hl: '让你的 Agent 可以"插件化成长"', delay: 0.95 },
							{ n: '03', title: 'ADLC · Agent Development Lifecycle', hl: '一套完整的工程方法论', delay: 1.1 },
						].map((s) => (
							<motion.div
								key={s.n}
							...
							>
								...
								<div style={{ flex: 1, minWidth: 0 }}>
									<div style={{ fontFamily: fonts.mono, fontSize: 15, color: '#555', fontWeight: 700, marginBottom: 3 }}>
										{s.title}
									</div>
				...
				>
					<div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
						<span style={{ fontFamily: fonts.heading, fontSize: '20px', color: colors.white, fontWeight: 900, letterSpacing: -0.3 }}>
							全栈班 → AI Engineer 进阶班 · 完整路径
						</span>
						<span style={{ padding: '3px 10px', background: colors.yellow, color: colors.black, fontFamily: fonts.mono, fontSize: 15, fontWeight: 900, border: `2px solid ${colors.white}` }}>
							进阶视野
						</span>
					</div>
					<div style={{ fontFamily: fonts.heading, fontSize: '18px', color: colors.yellow, fontWeight: 900, letterSpacing: -0.3 }}>
						AI 时代不只是用 Agent — 是造 Agent
					</div>
				</motion.div>
			</div>
		</Slide>
