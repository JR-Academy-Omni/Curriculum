...
```
设计任务：为「AI 漫画 Workshop」做配图 / 海报 / banner / 封面图。
课程定位：AI Comic·创意创作·人人能画（营销 / 创作线）
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #CB6CE6;`
