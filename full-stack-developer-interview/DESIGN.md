# 手撕全栈面试题班 — Design Spec

> Full-stack Developer Interview·硬核刷题
> 视觉系统所属：**工程 / 技术线**
...
```
设计任务：为「手撕全栈面试题班」做配图 / 海报 / banner / 封面图。
课程定位：Full-stack Developer Interview·硬核刷题（工程 / 技术线）
...
面试课偏严肃、考试感——钢蓝灰最合适。和工程线其他课的彩色拉开，海报上一眼能识别为「刷题/考试」。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #475569;`
