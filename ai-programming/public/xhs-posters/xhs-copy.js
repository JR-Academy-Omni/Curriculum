...
(function () {
  const XHS_COPY = {
    p1: { title: '做了 5 年 PPT 今年终于做出网站', body: `坐标写字楼隔间 🧡\n\n做了 5 年 PPT 和 Word，今年终于把一个想了很久的小工具真的做出来上线了。\n不是靠找外包，是自己在 Cursor 里跟 AI 一句一句描述，8 周跑完从 PRD 到 Vercel 部署全流程。\n\n课程叫匠人 AI Coding 实战课第 2 期，零基础能学，主页有完整大纲 ☕`, tags: '#AICoding #Vibecoding #Cursor #非技术AI #零代码建站 #产品经理', wechat: ['做了 5 年 PPT 今年终于做出网站 🧡','非技术背景 8 周上线一个真实产品 — 亲测可以。','用自然语言让 AI 写代码 — 就叫 Vibe Coding。'], community: ['【匠人 AI Coding 第 2 期开放咨询】\n8-12 周从零基础用 Cursor 做产品\n108 节课 + 29 Lab + 5 AI Tutor 带练\n零代码 · 主页查看大纲 🧡','之前一直想做小工具 — 8 周后手上真的有了可以点开访问的网站。'] },
    p1b: { title: '会用 ChatGPT 不等于你能做出产品', body: `聊了一圈身边想做产品的朋友 🧡\n\n大家都在用 ChatGPT，但真能做出东西上线的没几个。\n不是工具不够 — 是没人告诉你怎么用 Cursor 把想法变成代码，怎么推 GitHub，怎么部署 Vercel。\n\n第 2 期新加了 5 节 AI Tutor Quest —— AI 带着你一步步在自己电脑上真的做完。\n主页有 8 周课程路径 ☕`, tags: '#AICoding #Cursor #Vibecoding #非技术 #做产品', wechat: ['会用 ChatGPT ≠ 能做出产品 — 差距在动手那一步 🧡','问答很溜没东西上线 — 这是大多数人的状态。','第 2 期 5 节 Quest 是专治"打开 Cursor 就慌"的。'], community: ['【认知差距】\n会问 ChatGPT 的人很多\n能做出上线产品的人很少\n\n这就是 AI Coding 课要补的那一步 🧡','问 AI 和让 AI 干活是两回事 — 后者才有作品。'] },
    p1c: { title: '从写 PRD 到能独立上线产品', body: `过去两年我最想补的一块能力就是它 💼\n\n之前：写完 PRD 等开发排期，两周变两个月\n之后：打开 Cursor 自己做，周末就能出个能用的版本\n\n不需要学 Java / 算法，不需要 CS 背景。\n需要的是：会描述需求 + 一套 Vibe Coding 方法。\n\n8-12 周可以补齐，主页"匠人 AI · AI Coding"可看大纲 ☕`, tags: '#转岗 #产品经理 #AICoding #非技术AI', wechat: ['产品 / 运营最值得补的一块：用 AI 自己做产品 💼','等开发排期是老黄历了 — 自己做最快。','不学算法语法 — 几周就能上线作品。'], community: ['【转岗路径】\nBefore：写 PRD · 等开发\nAfter：打开 Cursor · 周末做完上线\n8-12 周补齐 · 不学语法 ☕','产品岗这两年真被 AI Coding 拉开了 — 能自己做 Demo 的就是比只写 PRD 的值钱。'] },
    p1d: { title: '不会 AI Coding 好点子永远停在 PPT', body: `这是我今年最大的感慨 ⚠️\n\n脑子里想了 5 个产品，每一个都卡在"找谁帮我做"。\n\n学了一个月 AI Coding 之后，写 PRD / 搭官网 / 部署 Vercel / 嵌 Chatbot / 做落地页 / 接外包 — 6 件事都能自己来了。\n\n8-12 周把"想做"变成"真的做过"，主页可看大纲 🧡`, tags: '#AICoding #独立开发 #副业 #SoloMaker #Cursor', wechat: ['不会 AI Coding 点子永远停在 PPT ⚠️','8-12 周把 6 件事从想做变成做过 🧡','创业点子不落地 — 其实就差这门课。'], community: ['【6 件能自己做】\n写 PRD · 搭官网 · 部署上线\n嵌 Chatbot · 做落地页 · 接外包\n每一件都能单独变现 🧡','想做产品但没人帮你 — 学完就不用再等别人了。'] },
    ...
    p16: { title: '基础班 8 周 进阶班 12 周两种节奏', body: `报课前看清楚节奏很重要 📅\n\n📅 W1 Cowork 起步（不碰编程工具）\n📅 W2 PRD + design.md\n📅 W3 PPT 第 1 个交付物\n📅 W4 PDF 全家桶\n📅 W5-6 Landing Page 网站 + 部署上线\n📅 W7 自动化基础 + 60s 视频\n📅 W8 一稿多发 + 基础班答辩\n📅 W9-12 进阶班：Chatbot + Admin + Agent + Dashboard\n\n每周 2 节直播，其余时间自由刷 Lab。`, tags: '#AICoding #学习路径 #8周 #12周', wechat: ['基础班 8 周 · 进阶班 12 周 · 按需自选 📅','每周 2 节直播 — 节奏稳，能跟得上。','想做带 AI 功能的产品 → 选 12 周进阶。'], community: ['【两种节奏】\n基础班 8 周：5 件真作品（PPT/PDF/网站/自动化/视频）\n进阶班 12 周：+ Chatbot + Admin CMS + Agent + Dashboard\n\n每周 2 节直播 · 不想做 Chatbot 可以只选 8 周 ✅'] },
    p17: { title: '8-12 周后你手上会有这些真产品', body: `买课最怕听完就完了 📂\n\n这次毕业手上有这些真作品：\n01 个人官网 / 简历站（Hero + 作品集 + 域名）\n02 产品落地页（能收邮箱预售）\n03 带 Chatbot 的网站（客服 / 售前）\n04 小型 SaaS 工具（表单 + 数据库 + AI）\n05 接官网外包的底气（能报价能交付）\n06 自己的作品集（4-6 个上线作品）\n\n都是能真点开访问的。`, tags: '#AICoding #毕业作品 #作品集', wechat: ['毕业 6 件真作品 — 都是能点开访问的 📂','作品集直接放 LinkedIn / 简历 / 自媒体。','能接外包的底气 — 比任何证书都有说服力。'], community: ['【毕业 6 产品】\n01 个人官网\n02 落地页\n03 Chatbot 网站\n04 小型 SaaS\n05 外包底气\n06 作品集','每一个都是你的 Demo URL 🧡'] },
