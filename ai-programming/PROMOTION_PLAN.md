...
> 维护人：Aurora / Seren（Marketing 主管）+ Beta（课程主理人）+ Lightman 把关
>
...
| **03 期 launch date** | ⚠️ 待运营 / Beta 定 — 推广节奏强依赖此日期 |
| **目标 Target Enrollment** | ⚠️ 待 Aurora + Beta 拍板（§2 给 50 / 80 / 120 三档反推参考）|
...
| 3. 线上讲座 | Beta | webinar-topic-feasibility | 2-3 场 | "零基础做出第一个产品"试听爆点 |
...
| 6. 销售页 | Dev + Beta | course-custom-landing | T-21 上线 | 零基础人群尤其需要"fit feeling"页面 |
...
|------|------|------|------|-------|------|------|---------|
| 周一 09:00 | 补 persona 真实访谈（PERSONAS §7 task 1+2+5）| Beta+顾问 | ✏️ | target-user-persona-mapper | 1d | **P0 前置** | coverage 过 50% |
| 周一 14:00 | 定 launch date + target + 定价（出 FUNNEL_PLAN）| Aurora+Beta+Lightman | ✏️ | course-funnel-architect | 半天 | **P0 前置** | FUNNEL_PLAN.md v1 |
| 周二 09:00 | 启动销售页（零基础人群强 fit feeling）| Dev | ✏️ | course-custom-landing | 5d | P0 | UAT 可访问 |
| 周二 11:00 | 第 1 场讲座 topic 审"零基础 30 分钟做出第一个网页" | Beta | 🤖→✏️ | webinar-topic-feasibility | 2h | P1 | 评分 ≥ 80 |
...
| 周二 19:30 | 第 1 场讲座（试听性质，现场做出一个网页）| Beta | ✏️ | — | 1.5h | P1 | 在线 ≥ 60 |
...
| 课程主理人 | Beta | persona 验证 / 讲座主持 / 销售页定位 / 定价 |
...
| **班级群运营 SOP** | [sops/COHORT_GROUP_OPERATIONS_SOP.md](./sops/COHORT_GROUP_OPERATIONS_SOP.md) | Beta / Beta 助教每日跑 cohort 班级群 |
...
- 🎯 下周目标（W1）：① Lightman 拍 launch date ② Beta 启动 02 期学员产出收集 ③ Aurora 跑首次 daily metrics ④ Beta 启动 02 期班级群 SOP ⑤ Marketing 文案岗 JD 发布
...
| Skill | 用途 | 触发频次 | 责任人 |
|-------|------|---------|--------|
| target-user-persona-mapper | persona 验证（前置）| 立即 + 季度 | Beta |
| course-funnel-architect | 定价/引流/三档（前置）| 立即 | Aurora+Beta |
| course-custom-landing | 销售页 | T-21 | Dev+Beta |
| xhs 四件套 | 小红书 9 篇/周 | 每周 | Summer |
| blog-longform-writer + wechat-article-quality | 公众号 1-2/周 | 每周 | 文案 |
| webinar-topic-feasibility | 讲座 topic 审 | 每场前 | Beta |
...
| **cohort-ops-conductor**（🆕 5/29 新建）| **cohort 全周期运营（D-1 → 结业）填补 Phase C 7% 黑洞** | **每日 / 每周** | **Beta + Beta 助教** |
