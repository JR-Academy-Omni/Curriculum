...
(function () {
  const XHS_COPY = {
    ...
    p10: { title: 'AI Adoption Specialist 一天到底在干嘛', body: `这岗位 2026 突然火了 — 但很多人没听过，更不知道每天具体在做什么 🤔\n\n用一句话讲清：\n👉 公司里那个把"AI 工具"变成"业务结果"的人。\n\n一天工作举例：\n• 早上：跟运营聊周报场景，发现一个能自动化的环节\n• 下午：给销售团队做 Copilot 培训\n• 傍晚：写本月 ROI 报告给老板\n• 下周：跟法务一起审 AI 政策草案\n\n零代码 · 业务理解就够 · 年薪 $120K-$200K+`, tags: '#AI采纳 #AI岗位 #职业规划 #非技术AI #新岗位', wechat: ['AI Adoption Specialist = 把 AI 工具变成业务结果的人 💼','2026 突然火的新岗位，零代码，年薪 $120K-$200K+','一图看懂 AI Adoption Specialist 一天在做什么 👇'], community: ['【新岗位 · 一句话讲清】\nAI Adoption Specialist\n= 公司里把"AI 工具"变成"业务结果"的人\n零代码 · 年薪 $120K-$200K+','别被名字吓到 — 简单说就是公司 AI 推手。一天做：场景识别 / 培训 / ROI / 政策 4 件事。'] },
