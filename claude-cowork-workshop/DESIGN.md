# Claude Cowork Workshop（3 小时通用） — Design Spec

> Anthropic Claude Cowork·桌面 App·非技术岗
> 视觉系统所属：**合作品牌线（Anthropic）**
...
```
设计任务：为「Claude Cowork Workshop（3 小时通用）」做配图 / 海报 / banner / 封面图。
课程定位：Anthropic Claude Cowork·桌面 App·非技术岗（合作品牌线（Anthropic））

═══ 主题色（必须严格执行）═══
主色：#D97757（Anthropic 珊瑚）
主色上的文字色：#FFFFFF
...
**直接采用 Anthropic 官方品牌色**——联名课沿用合作方主色，强化品牌联想。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #D97757;`
