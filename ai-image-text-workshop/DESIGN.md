# AI 小红书图文 Workshop — Design Spec

> 2.5 小时·零基础·跑通定位→选题→制作→发布
> 视觉系统所属：**营销 / 创作线**
...
```
设计任务：为「AI 小红书图文 Workshop」做配图 / 海报 / banner / 封面图。
课程定位：2.5 小时·零基础·跑通定位→选题→制作→发布（营销 / 创作线）
...
直接借用小红书平台原生色——海报放在小红书上有「原生感」，CTR 通常更高。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #FF2E4D;`
