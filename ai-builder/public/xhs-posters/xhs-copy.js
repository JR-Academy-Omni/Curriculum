/* Vibe Coding 提升班 第 2 期 — 三通道文案 */
(function () {
  const XHS_COPY = {
    p1: { title: '用 AI 从 PRD 到部署上线', body: `不是教你用 ChatGPT 写代码片段 🌟\n\n这门课是：Claude Code Skills + MCP Server + Agent 架构 → 从 PRD 到数据库到部署，全程 AI 驱动。\n\n8 周 · 113 节 · 39 Lab · 5 Quest\n第 2 期 · 面向有基础的开发者\n主页搜"匠人 AI · Vibe Coding" ☕`, tags: '#ClaudeCode #AICoding #MCP #Agent #Skills #VibeCoding', wechat: ['用 AI 从 PRD 到部署 — 不是写代码片段 🌟','Vibe Coding 第 2 期：Skills + MCP + Agent 三件套','8 周把 AI 工具链装成工程化工作流。'], community: ['【Vibe Coding 提升班 · 第 2 期】\n8 周 · 113 节 · 39 Lab · 5 Quest\nClaude Code Skills + MCP + Agent\n面向有基础开发者 ☕','Cursor 用腻了想升级？第 2 期筹备中，主页看大纲。'] },
