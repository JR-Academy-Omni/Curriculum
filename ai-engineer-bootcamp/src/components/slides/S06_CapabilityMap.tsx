			...
			<div style={{ width: '94%', maxWidth: 1400, height: '90%', padding: '28px 30px', display: 'flex', flexDirection: 'column' }}>
				...
				<motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: 12 }}>
					<div style={{ display: 'flex', alignItems: 'baseline', gap: 14, flexWrap: 'wrap' }}>
						<h2 style={{ fontFamily: fonts.heading, fontSize: '48px', fontWeight: 900, color: colors.black, letterSpacing: -1, lineHeight: 1.1 }}>
					...
					<p style={{ marginTop: 8, fontFamily: fonts.heading, fontSize: '19px', fontWeight: 700, color: '#444' }}>
					...
					{phases.map((p, i) => (
						...
						>
							...
							<div style={{ padding: '12px 14px', flex: 1, display: 'flex', flexDirection: 'column' }}>
								...
								{/* 英文名（大标题） */}
								<div style={{ fontFamily: fonts.heading, fontSize: '20px', fontWeight: 900, color: colors.black, lineHeight: 1.15, marginBottom: 4, letterSpacing: -0.4 }}>
									{p.name}
								</div>
								{/* 中文名（小标题） */}
								<div style={{ fontFamily: fonts.heading, fontSize: '16px', fontWeight: 700, color: '#555', lineHeight: 1.2, marginBottom: 10 }}>
									{p.nameCn}
								</div>

								{/* summary 截断 */}
								<div style={{ fontSize: '14px', color: '#333', lineHeight: 1.45, fontWeight: 500 }}>
