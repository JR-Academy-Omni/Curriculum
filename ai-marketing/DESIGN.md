# AI 营销全链路实战 4 周 — Design Spec

> 内容生产 / 投放 GEO / 私域 agent / 数据复盘
> 视觉系统所属：**营销 / 创作线**
...
```
设计任务：为「AI 营销全链路实战 4 周」做配图 / 海报 / banner / 封面图。
课程定位：内容生产 / 投放 GEO / 私域 agent / 数据复盘（营销 / 创作线）
...
营销「投放/转化/电商」语义的最强符号色。比 JR 红更深一档，避免和旗舰课撞色。
...
> 在 HTML/Slide 里使用时，以变量形式声明：`--theme-primary: #E63977;`
